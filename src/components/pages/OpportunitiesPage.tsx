...
import { Search, MapPin, DollarSign, TrendingUp, Calendar, ExternalLink, Loader2 } from 'lucide-react';
...
export default function OpportunitiesPage() {
  ...
  useEffect(() => {
    filterOpportunities();
  }, [opportunities, searchTerm, categoryFilter, locationFilter, compensationFilter, skillLevelFilter]);
  ...
  const filterOpportunities = () => {
    ...
    if (categoryFilter !== 'all') {
      filtered = filtered.filter((opp) => opp.category?.toLowerCase() === categoryFilter.toLowerCase());
    }
    ...
    if (compensationFilter !== 'all') {
      filtered = filtered.filter((opp) => opp.compensation?.toLowerCase() === compensationFilter.toLowerCase());
    }
        ...
        <div className="max-w-[100rem] mx-auto px-8">
          ...
          >
            ...
            <p className="font-paragraph text-xl md:text-2xl text-dark-grey/80">
              Discover verified opportunities from around the world. Filter by category, location, and more.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-[100rem] mx-auto px-8">
          ...
          <div className="mt-4">
            <Select value={skillLevelFilter} onValueChange={setSkillLevelFilter}>
              <SelectTrigger className="bg-background border-neutral-grey/30 font-paragraph max-w-xs">
                  ...
                  >
                    {opportunity.companyLogo && (
                      <div className="w-full h-48 bg-background flex items-center justify-center p-8">
                        <Image
                          ...
                          alt={opportunity.companyName || 'Company logo'}
                          width={200}
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="inline-block px-3 py-1 bg-primary/10 text-primary text-xs font-semibold rounded-full font-paragraph">
                          {opportunity.category}
                        </span>
                        {opportunity.compensation && (
                          <span className="inline-block px-3 py-1 bg-secondary/10 text-secondary text-xs font-semibold rounded-full font-paragraph">
                            {opportunity.compensation}
                          </span>
                        )}
                      </div>
