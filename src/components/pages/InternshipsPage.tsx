...
import { Search, MapPin, DollarSign, TrendingUp, Calendar, ExternalLink } from 'lucide-react';
...
export default function InternshipsPage() {
  ...
  const loadOpportunities = async () => {
    ...
    try {
      ...
      const internships = result.items.filter((opp) => opp.category?.toLowerCase() === 'internship');
        ...
        <div className="max-w-[100rem] mx-auto px-8">
          ...
          >
            ...
            <p className="font-paragraph text-xl md:text-2xl text-dark-grey/80">
              Find verified internship opportunities to kickstart your career.
            </p>
          </motion.div>
        </div>
      </section>
